...
headers = {
    ...
    'cookie': 'csrftoken=5GALGX2YNjOwhEIovhBkqtvOmslF45ir; ds_user_id=3538769271; mcd=3; mid=W_EZBAALAAGrY1CFgkWSnO_Dvpn2; sessionid=3538769271%3AR8hQLmN2gbwCTl%3A6; shbid=18628; shbts=1552874900.877566'
}
...
def main(user):
    ...
    html = get_html(url)
    urls = get_urls(html)
    dirpath = r'E:/laboratory/crawl/dataset/{0}'.format(user)
    ...
    for i in range(len(urls)):
        ...
        try:
            ...
            file_path = r'E:/laboratory/crawl/dataset/{0}/{1}.{2}'.format(user, md5(content).hexdigest(), urls[i][-43:-40])
            print(file_path)
